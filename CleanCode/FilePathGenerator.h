...
public:
    ...
    void serverFilespass1(const std::string& parentDirectory, std::vector<std::string>& filepaths);
    void serverFilesSIM(const std::string& parentDirectory, std::vector<std::string>& filepaths);
